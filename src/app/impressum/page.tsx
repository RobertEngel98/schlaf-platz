      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20">
        <div className="wrap max-w-[700px]">
          ...
          <div className="border-t border-gray-100 pt-6 space-y-6 text-[15px] leading-relaxed text-ink-light">
            ...
            <div>
              <h2 className="text-ink font-bold text-lg mb-3">Angaben gemäß § 5 TMG</h2>
            ...
            <div>
              <h2 className="text-ink font-bold text-lg mb-3">Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h2>
            ...
            <div>
              ...
              <p>Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: <a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer" className="text-sp hover:underline">https://ec.europa.eu/consumers/odr/</a>. Unsere E-Mail-Adresse finden Sie oben im Impressum.</p>
            </div>
            ...
            <div>
              <h2 className="text-ink font-bold text-lg mb-3">Haftung für Inhalte</h2>
            ...
            <div>
              <h2 className="text-ink font-bold text-lg mb-3">Haftung für Links</h2>
