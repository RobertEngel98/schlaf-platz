    ...
    <div className="bg-white">
      ...
      <div className="border-y border-gray-100 py-5 bg-gray-50/50">
        <div className="wrap grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {[{ v: "23", l: "Mitarbeiter" },{ v: "223%", l: "Umsatzwachstum" },{ v: "50+", l: "Städte" },{ v: "100%", l: "Remote möglich" }].map(s => (
            <div key={s.l}>
      ...
      <section className="py-12 md:py-16 border-b border-gray-100">
        <div className="wrap">
          ...
          <h2 className="font-display text-4xl md:text-5xl text-ink leading-[0.95] uppercase tracking-wide mb-10">Von der Idee zum Marktführer.</h2>
          <div className="space-y-0 max-w-[550px]">
            {[{ y: "2014", t: "Gründung durch Viktor Brehm" },{ y: "2018", t: "1.000 Partner-Meilenstein erreicht" },{ y: "2021", t: "Launch Transparenzregister" },{ y: "2023", t: "Expansion auf 50+ Städte" },{ y: "2025", t: "App-Launch & 1.500+ Partner" }].map((e, i) => (
      ...
      <section className="py-12 md:py-16">
        <div className="wrap">
          ...
          <div className="space-y-3">
            {[{ t: "Vertriebsmitarbeiter (m/w/d)", tag: "Vollzeit", l: "Remote / Düsseldorf" },{ t: "Kundenbetreuer (m/w/d)", tag: "Vollzeit", l: "Remote" },{ t: "Agenturpartner (m/w/d)", tag: "Freiberuflich", l: "Deutschlandweit" },{ t: "Werkstudent Marketing (m/w/d)", tag: "Teilzeit", l: "Remote / Düsseldorf" }].map((j, i) => (
