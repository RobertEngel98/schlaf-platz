    ...
    <div>
      ...
      <section className="relative bg-ink pt-32 pb-16 md:pt-40 md:pb-20 overflow-hidden">
        ...
        <div className="wrap relative z-10 max-w-[600px]">
          <h1 className="font-display text-3xl md:text-4xl text-white leading-tight">Allgemeine Geschaeftsbedingungen</h1>
        </div>
      </section>
      <section className="bg-white py-14 md:py-20">
        <div className="wrap max-w-[700px]">
          <p className="text-ink-light text-base leading-relaxed">Die vollstaendigen AGB der Schlaf-Platz e.G. werden in Kuerze hier veroeffentlicht.</p>
